...
**Implements:** ContentRef driver + fs ops
**Summary:** Windows/POSIX path normalization (Y:\ SMB bug; case-insensitive NTFS rename). Used by ai-file-renamer and media-processing.

/**
 * ai-file-renamer backend entrypoint.
 *
...
export const CAPABILITY_ID = 'ai-file-renamer';

/** Register health checks + job handlers with the core singletons. */
export function register(): void {
  health.register(CAPABILITY_ID, 'implemented', async () => ({
    state: 'unknown',
    detail: 'ai-file-renamer: no runtime service yet — capability is contracts-first',
  }));
}

/**
 * ai-orchestration backend entrypoint.
 *
...
export const CAPABILITY_ID = 'ai-orchestration';

/** Register health checks + job handlers with the core singletons. */
export function register(): void {
  health.register(CAPABILITY_ID, 'implemented', async () => ({
    state: 'unknown',
    detail: 'ai-orchestration: no runtime service yet — capability is contracts-first',
  }));
}

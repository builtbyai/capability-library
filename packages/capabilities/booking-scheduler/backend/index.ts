/**
 * booking-scheduler backend entrypoint.
 *
...
export const CAPABILITY_ID = 'booking-scheduler';

/** Register health checks + job handlers with the core singletons. */
export function register(): void {
  health.register(CAPABILITY_ID, 'implemented', async () => ({
    state: 'unknown',
    detail: 'booking-scheduler: no runtime service yet — capability is contracts-first',
  }));
}

/**
 * bulk-media-import backend entrypoint.
 *
...
export const CAPABILITY_ID = 'bulk-media-import';

/** Register health checks + job handlers with the core singletons. */
export function register(): void {
  health.register(CAPABILITY_ID, 'implemented', async () => ({
    state: 'unknown',
    detail: 'bulk-media-import: no runtime service yet — capability is contracts-first',
  }));
}

/**
 * cloudflare-deploy backend entrypoint.
 *
...
export const CAPABILITY_ID = 'cloudflare-deploy';

/** Register health checks + job handlers with the core singletons. */
export function register(): void {
  health.register(CAPABILITY_ID, 'implemented', async () => ({
    state: 'unknown',
    detail: 'cloudflare-deploy: no runtime service yet — capability is contracts-first',
  }));
}

/**
 * content-dashboard backend entrypoint.
 *
...
export const CAPABILITY_ID = 'content-dashboard';

/** Register health checks + job handlers with the core singletons. */
export function register(): void {
  health.register(CAPABILITY_ID, 'implemented', async () => ({
    state: 'unknown',
    detail: 'content-dashboard: no runtime service yet — capability is contracts-first',
  }));
}

/**
 * document-ingestion backend entrypoint.
 *
...
export const CAPABILITY_ID = 'document-ingestion';

/** Register health checks + job handlers with the core singletons. */
export function register(): void {
  health.register(CAPABILITY_ID, 'implemented', async () => ({
    state: 'unknown',
    detail: 'document-ingestion: no runtime service yet — capability is contracts-first',
  }));
}

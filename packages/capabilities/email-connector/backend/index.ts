/**
 * email-connector backend entrypoint.
 *
...
export const CAPABILITY_ID = 'email-connector';

/** Register health checks + job handlers with the core singletons. */
export function register(): void {
  health.register(CAPABILITY_ID, 'implemented', async () => ({
    state: 'unknown',
    detail: 'email-connector: no runtime service yet — capability is contracts-first',
  }));
}

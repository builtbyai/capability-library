/**
 * everything-search backend entrypoint.
 *
...
export const CAPABILITY_ID = 'everything-search';

/** Register health checks + job handlers with the core singletons. */
export function register(): void {
  health.register(CAPABILITY_ID, 'implemented', async () => ({
    state: 'unknown',
    detail: 'everything-search: no runtime service yet — capability is contracts-first',
  }));
}

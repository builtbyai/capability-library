/**
 * geo-visualization backend entrypoint.
 *
...
export const CAPABILITY_ID = 'geo-visualization';

/** Register health checks + job handlers with the core singletons. */
export function register(): void {
  health.register(CAPABILITY_ID, 'implemented', async () => ({
    state: 'unknown',
    detail: 'geo-visualization: no runtime service yet — capability is contracts-first',
  }));
}

/**
 * intake-pipeline backend entrypoint.
 *
...
export const CAPABILITY_ID = 'intake-pipeline';

/** Register health checks + job handlers with the core singletons. */
export function register(): void {
  health.register(CAPABILITY_ID, 'implemented', async () => ({
    state: 'unknown',
    detail: 'intake-pipeline: no runtime service yet — capability is contracts-first',
  }));
}

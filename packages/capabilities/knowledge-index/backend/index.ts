/**
 * knowledge-index backend entrypoint.
 *
...
export const CAPABILITY_ID = 'knowledge-index';

/** Register health checks + job handlers with the core singletons. */
export function register(): void {
  health.register(CAPABILITY_ID, 'implemented', async () => ({
    state: 'unknown',
    detail: 'knowledge-index: no runtime service yet — capability is contracts-first',
  }));
}

/**
 * media-generation backend entrypoint.
 *
...
export const CAPABILITY_ID = 'media-generation';

/** Register health checks + job handlers with the core singletons. */
export function register(): void {
  health.register(CAPABILITY_ID, 'implemented', async () => ({
    state: 'unknown',
    detail: 'media-generation: no runtime service yet — capability is contracts-first',
  }));
}

/**
 * media-processing backend entrypoint.
 *
...
export const CAPABILITY_ID = 'media-processing';

/** Register health checks + job handlers with the core singletons. */
export function register(): void {
  health.register(CAPABILITY_ID, 'implemented', async () => ({
    state: 'unknown',
    detail: 'media-processing: no runtime service yet — capability is contracts-first',
  }));
}

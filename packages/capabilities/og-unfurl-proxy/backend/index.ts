/**
 * og-unfurl-proxy backend entrypoint.
 *
...
export const CAPABILITY_ID = 'og-unfurl-proxy';

/** Register health checks + job handlers with the core singletons. */
export function register(): void {
  health.register(CAPABILITY_ID, 'implemented', async () => ({
    state: 'unknown',
    detail: 'og-unfurl-proxy: no runtime service yet — capability is contracts-first',
  }));
}

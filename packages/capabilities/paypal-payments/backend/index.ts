/**
 * paypal-payments backend entrypoint.
 *
...
export const CAPABILITY_ID = 'paypal-payments';

/** Register health checks + job handlers with the core singletons. */
export function register(): void {
  health.register(CAPABILITY_ID, 'implemented', async () => ({
    state: 'unknown',
    detail: 'paypal-payments: no runtime service yet — capability is contracts-first',
  }));
}

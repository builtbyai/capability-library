/**
 * performance-loop backend entrypoint.
 *
...
export const CAPABILITY_ID = 'performance-loop';

/** Register health checks + job handlers with the core singletons. */
export function register(): void {
  health.register(CAPABILITY_ID, 'implemented', async () => ({
    state: 'unknown',
    detail: 'performance-loop: no runtime service yet — capability is contracts-first',
  }));
}

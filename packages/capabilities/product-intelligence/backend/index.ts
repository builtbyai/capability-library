/**
 * product-intelligence backend entrypoint.
 *
...
export const CAPABILITY_ID = 'product-intelligence';

/** Register health checks + job handlers with the core singletons. */
export function register(): void {
  health.register(CAPABILITY_ID, 'implemented', async () => ({
    state: 'unknown',
    detail: 'product-intelligence: no runtime service yet — capability is contracts-first',
  }));
}

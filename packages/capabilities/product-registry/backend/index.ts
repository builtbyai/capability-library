/**
 * product-registry backend entrypoint.
 *
...
export const CAPABILITY_ID = 'product-registry';

/** Register health checks + job handlers with the core singletons. */
export function register(): void {
  health.register(CAPABILITY_ID, 'implemented', async () => ({
    state: 'unknown',
    detail: 'product-registry: no runtime service yet — capability is contracts-first',
  }));
}

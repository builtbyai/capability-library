/**
 * screenshot-capture backend entrypoint.
 *
...
export const CAPABILITY_ID = 'screenshot-capture';

/** Register health checks + job handlers with the core singletons. */
export function register(): void {
  health.register(CAPABILITY_ID, 'implemented', async () => ({
    state: 'unknown',
    detail: 'screenshot-capture: no runtime service yet — capability is contracts-first',
  }));
}

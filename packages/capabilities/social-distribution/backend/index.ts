/**
 * social-distribution backend entrypoint.
 *
...
export const CAPABILITY_ID = 'social-distribution';

/** Register health checks + job handlers with the core singletons. */
export function register(): void {
  health.register(CAPABILITY_ID, 'implemented', async () => ({
    state: 'unknown',
    detail: 'social-distribution: no runtime service yet — capability is contracts-first',
  }));
}

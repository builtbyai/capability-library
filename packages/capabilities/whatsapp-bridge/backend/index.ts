/**
 * whatsapp-bridge backend entrypoint.
 *
...
export const CAPABILITY_ID = 'whatsapp-bridge';

/** Register health checks + job handlers with the core singletons. */
export function register(): void {
  health.register(CAPABILITY_ID, 'implemented', async () => ({
    state: 'unknown',
    detail: 'whatsapp-bridge: no runtime service yet — capability is contracts-first',
  }));
}

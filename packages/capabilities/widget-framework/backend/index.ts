/**
 * widget-framework backend entrypoint.
 *
...
export const CAPABILITY_ID = 'widget-framework';

/** Register health checks + job handlers with the core singletons. */
export function register(): void {
  health.register(CAPABILITY_ID, 'implemented', async () => ({
    state: 'unknown',
    detail: 'widget-framework: no runtime service yet — capability is contracts-first',
  }));
}

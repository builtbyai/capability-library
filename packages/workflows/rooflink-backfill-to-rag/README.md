# rooflink-backfill-to-rag

**Composes:** bulk-media-import,intake-pipeline,document-ingestion,media-processing,knowledge-index
**Trigger:** CLI invocation
**Summary:** Bulk import -> fan to doc+media -> embed docs
